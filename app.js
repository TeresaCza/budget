    ...
    changeType: function() {
      ...
      var fields = document.querySelectorAll(
       ...
       nodeListForEach(fields, function(cur){
        ...
        } else if (type === 'inc' && cur.classList.contains('red-focus')) {
      ...
      } else if (type === 'inc' && btn.classList.contains('red')){
...
var controller = (function(budgetCtrl, UICtrl) {
  ...
  var updatePercentages = function() {
    ...
    //3. Update the UI with he new percentages
